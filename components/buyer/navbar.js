...
export default function Navbar() {
  ...
  const DropdownMenu = ({ items, isOpen, onClose }) =>
    isOpen && (
      <div className="absolute left-1/2 transform -translate-x-1/2 mt-2 w-[90vw] max-w-[1200px] bg-white rounded-md shadow-lg py-4 z-50 transition-opacity duration-200">
              ...
              <ul>
                ...
                <li>
                  <Link
                    ...
                    className="block px-2 py-1 text-sm text-primary hover:text-primary font-medium"
                    onClick={onClose}
                  >
                    View All
                  </Link>
            ...
            <div className="relative z-10 h-full">
              <div className="max-w-[1200px] mx-auto px-4 md:px-6 lg:px-8 h-full">
                <nav className="hidden md:flex items-center justify-center h-full space-x-8">
                  ...
                  >
                    Categories <ArrowRight className="ml-1 h-4 w-4" />
                  </Link>
                  ...
                  >
                    ...
                    <DropdownMenu
                      ...
                      isOpen={activeDropdown === "softwares"}
                      onClose={() => setActiveDropdown(null)}
                    />
                  </div>
            ...
            {isLoggedIn ? (
              <>
                ...
                <nav className="flex flex-col space-y-3">
                  ...
                  <div className="relative">
                    <button
                      onClick={() => setActiveDropdown(activeDropdown === "softwares" ? null : "softwares")}
                      className="px-3 py-2 text-text hover:text-primary flex items-center justify-between w-full font-medium"
                    >
                      Softwares <ChevronDown className="h-4 w-4" />
                    </button>
                    {activeDropdown === "softwares" && (
                      <div className="pl-6 mt-1 space-y-1">
