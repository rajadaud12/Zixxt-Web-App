...
export default function ServiceDetail({ params }) {
    ...
    return (
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="lg:w-2/3">
                        <div className="w-full bg-white">
                            ...
                            <div className="max-w-[40.8125rem] lg:max-w-[48rem] xl:max-w-[60rem] mx-auto px-4 pt-6 pb-8">
                            ...
                            {/* Image Gallery */}
                            <div className="relative w-full rounded-lg overflow-hidden max-w-[40.8125rem] lg:max-w-[48rem] xl:max-w-[60rem] mx-auto mt-8" style={{ aspectRatio: '653 / 371' }}>
                                {/* Main Gallery Image */}
                                <img
                            ...
                            <div className="max-w-[40.8125rem] lg:max-w-[48rem] xl:max-w-[60rem] mx-auto px-4 pt-6 flex items-center">
                                <button
                                ...
                                <div className="flex-1 overflow-hidden">
                                    ...
                                    >
                                        {service.galleryImages.map((image, index) => (
                                            <div
                                                key={index}
                                                className={`w-[6.25rem] h-[3.5625rem] lg:w-[7.5rem] lg:h-[4.25rem] flex-shrink-0 overflow-hidden cursor-pointer ${index === currentImageIndex ? 'border-2 border-[#3B82F6]' : 'border border-gray-300'
                                                    } rounded-2xl`}
                        ...
                        {/* Auto Discount Alert */}
                        <div className="max-w-[40.8125rem] lg:max-w-[48rem] xl:max-w-[60rem] mx-auto flex items-start bg-secondary border border-border rounded-lg p-4 mt-8 mb-8">
                        ...
                        {/* Description Section */}
                        <div className="max-w-[40.8125rem] lg:max-w-[48rem] xl:max-w-[60rem] mx-auto mb-8">
                        ...
                        <div className="max-w-[40.8125rem] lg:max-w-[48rem] xl:max-w-[60rem] mx-auto mb-12">
                                    ...
                                    <div className="flex justify-between items-center mb-4">
                                        <div className="flex space-x-2">
                                            <button className="p-2 rounded-full bg-white border border-border">
                                                <Heart className={`w-5 h-5 ${wishlist ? 'text-red-500 fill-red-500' : 'text-textLight'}`} onClick={() => setWishlist(!wishlist)} />
                                            </button>
                                            <button className="p-2 rounded-full bg-white border border-border">
                                        ...
                                        <span className="text-xs text-primary font-medium bg-[#E6F2FF] px-3 py-1 rounded-full">{String(currentPackage.duration).padStart(2, '0')} DAYS</span>
                                    </div>
        ...
        ${index !== 2 ? 'border-r-0' : ''}`} // Remove right border for all except last
